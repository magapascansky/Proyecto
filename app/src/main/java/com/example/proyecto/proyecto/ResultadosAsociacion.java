...
public class ResultadosAsociacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_asociacion);
        referecias();
        consulta();
    ...
    public void consulta() {
        ...
        String[] args = new String[] {"2", Integer.toString(MainActivity.idUsuario)};
