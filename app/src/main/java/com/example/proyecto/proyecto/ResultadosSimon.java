...
public class ResultadosSimon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_simon);
        referecias();
        consulta();
    ...
    public void consulta() {
        ...
        String[] args = new String[] {"3", Integer.toString(MainActivity.idUsuario)};
